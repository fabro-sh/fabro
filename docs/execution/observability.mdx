...
<Frame caption="The Stages tab shows the full agent conversation including tool calls and responses.">
  <img src="/images/web/run-stages.png" alt="Arc web UI run stages showing agent conversation with tool calls" />
</Frame>
...
<Frame caption="The Usage tab breaks down token counts and costs by stage and by model.">
  <img src="/images/web/run-usage.png" alt="Arc web UI run usage showing per-stage and per-model token and cost breakdown" />
</Frame>
