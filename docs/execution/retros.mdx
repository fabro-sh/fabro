...
<Frame caption="The Retros page shows all retrospectives with smoothness ratings, duration, and friction counts.">
  <img src="/images/web/retros-list.png" alt="Arc web UI Retros list showing runs with Smooth, Bumpy, Effortless, and Struggled ratings" />
</Frame>
...
<Frame caption="A run's Retro tab shows the smoothness rating, stats, learnings, and open items.">
  <img src="/images/web/run-retro.png" alt="Arc web UI run retro showing Smooth rating, duration, cost, learnings, and follow-up items" />
</Frame>
