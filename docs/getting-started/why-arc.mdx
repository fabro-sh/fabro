...
<img src="/images/run-detail.png" alt="Arc run detail view showing verifications for a pipeline event types change, including Traceability, Readability, Reliability, Code Coverage, and more" />
...
<img src="/images/workflow-example.png" alt="Arc workflow diagram for Fix Build showing stages from Start through Analyze Build Errors, Diagnose Root Cause, Validate Build, and Review Changes to Exit" />
