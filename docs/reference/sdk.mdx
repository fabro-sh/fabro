...
pub fn new(
    ...
    subagent_manager: Option<Arc<tokio::sync::Mutex<fabro_agent::subagent::SubAgentManager>>>,
) -> Self
```
...
|---|---|---|
| `new(model, client)` | `(impl Into<String>, impl Into<Arc<Client>>)` | Required. Model ID or alias plus the client to use |
