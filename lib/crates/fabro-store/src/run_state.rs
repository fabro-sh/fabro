...
mod tests {
    ...
    use fabro_types::{
        ...
        FailureReason, Graph, McpServerStatus, Outcome, PullRequestLink, QuestionType, RunBlobId,
        RunControlAction, RunDiff, RunEvent, RunSpec, RunStatus, StageOutcome, StageState,
