    ...
    match event {
        ...
        Event::Agent { visit, event, .. } => match event {
            ...
            AgentEvent::TodoCreated {
                ...
                blocked_by,
                metadata,
            } => EventBody::TodoCreated(fabro_types::TodoCreatedProps {
            ...
            AgentEvent::TodoUpdated {
                ...
                add_blocked_by,
                metadata_patch,
            } => EventBody::TodoUpdated(fabro_types::TodoUpdatedProps {
                list_id:        list_id.clone(),
                list_kind:      *list_kind,
                todo_id:        todo_id.clone(),
                status:         *status,
                ...
                active_form:    active_form.clone(),
                owner:          owner.clone(),
                add_blocks:     add_blocks.clone(),
                add_blocked_by: add_blocked_by.clone(),
                metadata_patch: metadata_patch.clone(),
            }),
            AgentEvent::TodoDeleted {
                list_id,
                list_kind,
                todo_id,
            } => EventBody::TodoDeleted(fabro_types::TodoDeletedProps {
                list_id:   list_id.clone(),
                list_kind: *list_kind,
                todo_id:   todo_id.clone(),
            }),
